...
export default function Profile() {
  ...
  return (
    <div className="absolute inset-0">
      <main className="flex max-h-screen min-h-screen flex-col items-center justify-start gap-4 overflow-hidden bg-gradient-to-b from-blue-900 to-blue-500 p-4 md:max-h-full md:justify-center">
        <button
              ...
              .map(([key, value]) => (
                ...
                >
                  <div className="flex items-center justify-between py-1">
                    <div className="w-32">
                      <div className="sm:text-md text-sm capitalize text-gray-500">
